...
public class MICROAPPActivity extends Activity implements InfoInterface {
	/** Called when the activity is first created. */
	  ListView list;
	  static String[] web = {"VoiceRecognition","PhoneStatusActivity","Email"
	        
	    } ;
	    Integer[] imageId = {R.drawable.voicerecognization,R.drawable.status,R.drawable.email
			        ...
			        list=(ListView)findViewById(R.id.list);
			                ...
			                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			                    ...
			                    public void onItemClick(AdapterView<?> parent, View view,
			                        ...
			                        /**hereactivitychanges**/
if(web[+ position].equals("VoiceRecognition")){dynamic_class=VoiceRecognition.class;nextActivity();}
if(web[+ position].equals("PhoneStatusActivity")){dynamic_class=PhoneStatusActivity.class;nextActivity();}
if(web[+ position].equals("Email")){dynamic_class=Email.class;nextActivity();}
