...
public class MICROAPPActivity extends Activity implements InfoInterface {
	/** Called when the activity is first created. */
	  ListView list;
	  static String[] web = {"TakePhoto","PhotoPreview","Email"
	        
	    } ;
	    Integer[] imageId = {R.drawable.takephoto,R.drawable.photopreview,R.drawable.email
			        ...
			        list=(ListView)findViewById(R.id.list);
			                ...
			                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			                    ...
			                    public void onItemClick(AdapterView<?> parent, View view,
			                        ...
			                        /**hereactivitychanges**/
if(web[+ position].equals("TakePhoto")){dynamic_class=TakePhoto.class;nextActivity();}
if(web[+ position].equals("PhotoPreview")){dynamic_class=PhotoPreview.class;nextActivity();}
